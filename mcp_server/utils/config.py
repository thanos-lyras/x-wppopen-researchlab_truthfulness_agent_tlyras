"""Shared config: paths, hyperparams, label map, system prompt."""
...
# FINE_TUNED_MODEL is intentionally NOT read here — predict_fine_tuned and
# check_finetune_status read `os.environ.get(...)` at call time so a fresh
# endpoint takes effect without restarting the MCP server.
...
# Vertex Gemini SFT requires a regional endpoint ("global" rejects tuning).
